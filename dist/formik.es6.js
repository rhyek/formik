...
var Formik = (function (_super) {
    ...
    function Formik(props) {
        ...
        _this.handleChange = function (eventOrString) {
            var executeChange = function (e, path) {
                e.persist();
                var field = path;
                var val = e;
                var parsed;
                if (!isReactNative) {
                    var _a = e.target, type = _a.type, name_1 = _a.name, id = _a.id, value = _a.value, checked = _a.checked, outerHTML = _a.outerHTML;
                    field = path ? path : name_1 ? name_1 : id;
            ...
            if (isString(eventOrString)) {
                return typeof _this.hcCache[eventOrString] === 'function'
                    ? _this.hcCache[eventOrString]
                    : (_this.hcCache[eventOrString] = function (event) {
        ...
        _this.handleBlur = function (eventOrString) {
            ...
            if (isString(eventOrString)) {
                return typeof _this.hbCache[eventOrString] === 'function'
...
export { Formik, yupToFormErrors, validateYupSchema, Field, Form, withFormik, move, swap, insert, FieldArray, getIn, setIn, setNestedObjectValues, isReactNative, isFunction$1 as isFunction, isObject$1 as isObject, isInteger, isString, isEmptyChildren, isPromise, FastField };
